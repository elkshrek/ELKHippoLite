...
{
    return [self elk_rotate:UIImageOrientationDownMirrored];
}

/** 水平翻转 */
- (UIImage *)elk_flipHorizontal
{
    return [self elk_rotate:UIImageOrientationUpMirrored];
}
...
{
    return [self elk_imageRotatedByRadians:kDegreesToRadian(degrees)];
}
